...
public class UpdateOrderVO_Test {
	
	public void updateOrderVOforChangeOfService (Parameters apiParams, 
		...
		//if (wIPConstraintsVO.getCancelRsn().getRequired()) {
		//	orderVO.setCancelReasonCode(apiParams.getCancelReason());
		//}
		...
		// orderVO.setSiteId(apiParams.getSite_id());
	...
	public void updateOrderVOforRescheduleOrderChange (Parameters apiParams, 
			 PrintOutput printOutput,
			 OrderInfoVO orderInfoVO,
			 ServicePointVO[] servicePointVOList,
			 OrderVO orderVO,
		...
		// setBlankOutRphoneFlag(short blankOutRphoneFlag)
		// setCallerName(java.lang.String callerName)
		if (wIPConstraintsVO.getChangeStatusRsn().getRequired()) {
		orderVO.setCancelReasonCode(apiParams.getChangeReason());
		}
		// setClrInfoFlag(short clrInfoFlag)
		// setContract(ContractVO[] contract)
		// setCreateNewAddr(java.lang.Boolean createNewAddr)
	...
	public void updateOrderVOforRescheduleOrderDatesOnly (Parameters apiParams, 
					 PrintOutput printOutput,
					 OrderInfoVO orderInfoVO,
					 ServicePointVO[] servicePointVOList,
					 OrderVO orderVO,
		...
		public void updateOrderVOforRescheduleSRO (Parameters apiParams, 
		PrintOutput printOutput,
		OrderInfoVO orderInfoVO,
		ServicePointVO[] servicePointVOList,
		OrderVO orderVO,
	...
	public void updateOrderVOforRescheduleOrder (Parameters apiParams, 
			 									 PrintOutput printOutput,
			 									 OrderInfoVO orderInfoVO,
			 									 ServicePointVO[] servicePointVOList,
			 									 OrderVO orderVO,
	...
	public void updateOrderVOforSRO (Parameters apiParams, PrintOutput printOutput, WIPConstraintsVO wIPConstraintsVO, OrderVO orderVO) {
...
public void updateOrderVOforInstall (Parameters apiParams, 
									 PrintOutput printOutput,
									 OrderInfoVO orderInfoVO,
									 ServicePointVO[] servicePointVOList,
									 OrderVO orderVO) {
...
public void updateOrderVOforInstallWithContract (Parameters apiParams, 
												 PrintOutput printOutput,
												 ContractVO[] contractVOList,
												 OrderInfoVO orderInfoVO,
												 ServicePointVO[] servicePointVOList,
												 OrderVO orderVO) {
