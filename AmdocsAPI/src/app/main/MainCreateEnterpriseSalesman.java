...
import app.opr.OprCreateEnterpriseSalesmanTest;
import util.Lock;
import util.Login;
import util.Parameters;
import util.PrintOutput;

public class MainCreateEnterpriseSalesman {
	public static void main(String[] args) {
		...
		apiParams.initParameters(Parameters.CREATE_NEW_ENT_SALESMAN, apiParams, printOutput);

		// API test objects - create current test objects
		OprCreateEnterpriseSalesmanTest oprCreateEnterpriseSalesmanTest = new OprCreateEnterpriseSalesmanTest();
		...
		if (session){
			...
			if (APC_lock == false){
				oprCreateEnterpriseSalesmanTest.setData(apiParams, login, printOutput);
				oprCreateEnterpriseSalesmanTest.saveData(apiParams, login, printOutput);
			}
