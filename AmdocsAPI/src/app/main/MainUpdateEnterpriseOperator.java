...
import app.opr.OprUpdateEnterpriseOperatorTest;
import util.Lock;
import util.Login;
import util.Parameters;
import util.PrintOutput;

public class MainUpdateEnterpriseOperator {
	...
	public static void main(String[] args) {
		...
		apiParams.initParameters(Parameters.UPDATE_ENTERPRISE_OPERATOR, apiParams, printOutput);
		
		// API test objects - create current test objects
		OprUpdateEnterpriseOperatorTest oprUpdateEnterpriseOperatorTest = new OprUpdateEnterpriseOperatorTest();
		...
		if (session){
			...
			if (APC_lock == false){
				oprUpdateEnterpriseOperatorTest.getData(apiParams,  login, printOutput);
				//oprUpdateEnterpriseOperatorTest.setData(apiParams,  login, printOutput);
				//oprUpdateEnterpriseOperatorTest.saveData(apiParams, login, printOutput);
			}
