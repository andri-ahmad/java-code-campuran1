...
public class MainInstallwithPromoSchedule {
        ...
        try {
            ...
            if (session) {
                ...
                if (siteLock && varLock) {
                    ...
                    customerDetailsVO.setBillingAddress("TESTING BILLING");
                    
                    //customerDetailsVO.setBillingAddressFieldsArr(siteDetailsVO.getAddressId().get)
                    //customerDetailsVO.setBillingAddress(arg0);
